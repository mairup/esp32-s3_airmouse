...
def parse_command_line_arguments():
    ...
    parser.add_argument("--pan-axis-lock-thresh", type=float, default=DEFAULT_PAN_AXIS_LOCK_THRESHOLD, help=f"Minimum accumulated translated scroll distance before locking to an axis (default: {DEFAULT_PAN_AXIS_LOCK_THRESHOLD})")
