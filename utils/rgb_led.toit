...
// Precomputed breathe curve for 200 ticks (2.0s at 100Hz)
// Replaces expensive math operations in the loop
BREATHE-CURVE ::= [
  ...
  run_ -> none:
    ...
    while true:
      ...
      if state == BleServer.STATE-STOPPED:
        ...
        r = 0
        g = 0
        b = BREATHE-CURVE[ticks]
        // Cap the maximum value at 255 (duty factor must be <= 1.0)
        if b > 255: b = 255
